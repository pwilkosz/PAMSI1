...
konstruktor parametryczny -\/ alokuje pamiec w dynamicznej tablicy {\ttfamily tab} {\ttfamily } 


\begin{DoxyParams}[1]{\-Parametry}
\mbox{\tt in}  & {\em \-N} & -\/ ilosc elementow w tablicy; parametr przypisywany do pola {\ttfamily n} {\ttfamily w} klasie, oraz alokuje pamiec o takim wlasnie rozmiarze \\
\hline
\end{DoxyParams}
